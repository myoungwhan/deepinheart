...
class SettingsData {
  ...
  final String webrtcTurnServers;
  ...
  SettingsData({
    ...
    required this.webrtcSignalingUrl,
    required this.webrtcTurnServers,
  ...
  factory SettingsData.fromJson(Map<String, dynamic> json) {
    return SettingsData(
      ...
      webrtcSignalingUrl: json['webrtc_signaling_url']?.toString() ?? '',
      webrtcTurnServers: json['webrtc_turn_servers']?.toString() ?? '',
